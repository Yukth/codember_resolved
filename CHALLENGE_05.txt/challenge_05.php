...
$corrupted_csv = 'PYmt8hd,jdcrLI,jdcrli@gmail.com,27,London
...
function pre_process_raw_data($raw_data){
    $raw_array_corrupted_csv = str_getcsv($raw_data,PHP_EOL);

    $pre_process_raw_data = array_map(function($raw_csv_data) {
        return explode(',',$raw_csv_data);
    }, $raw_array_corrupted_csv);
